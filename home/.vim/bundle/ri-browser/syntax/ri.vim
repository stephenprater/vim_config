...
syn include @riRuby $VIMRUNTIME/ftplugin/ruby.vim

syn region	riHeader	start=/=/ end=/$/ contains=riBackspace
syn match	riBackspace	/./ conceal
...
if version >= 508 || !exists("did_help_syntax_inits")
  ...
  hi riHeader			term=bold gui=bold
