...
if has("gui_running")
  ...
  hi StatusLine     guibg=#000000 guifg=#DDD9D7 gui=none
  hi StatusLineNC   guibg=#25365a guifg=#AAA7A5 gui=none
  ...
  " -> Code
  hi Comment        guibg=#1F1F1F guifg=#797577 gui=none
...
"
  ...
  hi link     rubyObjectMethodCall     rubyMethod
  hi link     rubyTernary              Operator
 
  hi Pmenu                       guibg=#140100 guifg=#993333 gui=none
  hi Boolean                     guifg=#45B4FF
  hi Operator                    guibg=#1F1F1F guifg=#CA746A gui=none
  hi rubyDefine                  guibg=#1F1F1F guifg=#E783E9 gui=bold
  hi rubyInterpolation           guifg=#FFB539 guibg=#4C2E10
  hi rubyInterpolationDelimiter  guifg=#FFAA00 guibg=#4C2E10
  hi rubyInstanceVariable        guifg=#EE8844
  hi rubyRegexpDelimiter         guifg=#02EE02 guibg=#003300
  hi rubyRegexpSpecial           guifg=#00FF00 guibg=#003300
  hi rubyRegexp                  guifg=#02DD02 guibg=#003300
  hi rubyRegexpEscape            guifg=#00FF00 guibg=#003300
  hi rubyLocalMethodCall         guifg=#A0A0D0 guibg=NONE
  hi rubyMethod                  guifg=#BFBF55
  hi rubyBrackets                guifg=#809080
  hi rubyBlockParameter          guifg=#FF55FF guibg=#101010
  hi rubyBlockParameterList      guibg=#101010
  hi rubyBlockArgument           guifg=#FF55FF

  hi link rubyRailsUserClass rubyConstant
  hi link rubyRailsMethod Function
  
" MiniBufExplorer
  hi MBENormal                   guifg=#A0A0A0
  hi MBEVisibleNormal            guifg=#1F1F1F guibg=#CCDDE3 
  hi MBEVisibleChanged           guifg=#1F1F1F guibg=#DDAAAA
