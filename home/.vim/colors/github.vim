...
hi StatusLine   guibg=#bbbbff guifg=#404040 gui=bold
...
hi Number       guifg=#005500
hi rubyMethod   guifg=#1C9898 gui=bold
hi rubyConstant guifg=#002255 gui=bold
hi Statement    guifg=#221111 gui=bold
hi rubyInterpolation guibg=#DDFFDD
hi link rubyControl Statement
hi link rubyObjectMethodCall rubyMethod
hi rubyPseudoVariable guifg=#006E35 gui=italic
hi rubyBlockParameter guifg=#551111
hi rubyBrackets guifg=#555555 guibg=#EEEEEE
hi link rubyExpressionDelimiter rubyBrackets
hi rubyOperator guifg=#0E005C gui=bold
hi rubyLocalMethodCall guifg=#0D3434 guibg=NONE
hi rubyInstanceVariable guifg=#3333BB
hi rubyRegexpDelimiter guibg=#FFDDDD guifg=#FF0000
hi rubyRegexpSpecial guibg=#FFDDDD
hi rubyRegexp guibg=#FFDDDD
" }}}
